...
public class Main3 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //获取当前方法所有参数信息，Parameter表示参数信息，一个Parameter
        //表示一个参数对象
        ...
        //调用当前方法, 使用invoke方法，参数一传入当前类的实例，第二个参数
        //开始是一个可变参数，表示方法的实参,如果方法有返回值，
        ...
        //私有方法是不能直接访问的，调用前也必须先打开访问开关
        method2.setAccessible(true);
        //run方法没有参数，因此调用invoke时候不需要传入实参，只需传入当前类实例
        method2.invoke(obj);
